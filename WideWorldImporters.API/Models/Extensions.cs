...
namespace WideWorldImporters.API.Models
{
    ...
    {
        public static IQueryable<StockItem> GetStockItems(this WideWorldImportersDbContext dbContext, int pageSize = 10, int pageNumber = 1, int? lastEditedBy = null, int? colorID = null,
                                                                int? outerPackageID = null, int? supplierID = null, int? unitPackageID = null)
        {
            //Get query from Dbset
            var query = dbContext.StockItems.AsQueryable();

            //Filter by : 'LastEditBy'
