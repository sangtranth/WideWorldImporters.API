...
#pragma warning restore CS1591
        ...
        public async Task<IActionResult> GetStockItemsAsync(int pageSize = 10, int pageNumber = 1, int? lastEditedBy = null, int? colorID = null, int? outerPackgeID = null, int? supplierID = null,
            int? unitPackgeID = null)
        {
